...
public class CustomListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        if (vi == null) {
            ...
            CustomOrderModel customListDataModel = (CustomOrderModel) customListDataModelArrayList.get(pos);

//            pricing_item.image_view.setImageResource(customListDataModel.getImage_id());
            pricing_item.repair_part_model.setText("Order Id:\t" + customListDataModel.getId());
            pricing_item.repairing_part_name.setText("User Phone Number\t" + customListDataModel.getUserPhoneNumber());
